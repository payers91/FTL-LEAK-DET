...
epicsEnvSet("LOCATION", "PLC:plc_ftl_leak_det" )
...
dbLoadRecords("iocSoft.db", "IOC=PLC:plc_ftl_leak_det")
dbLoadRecords("save_restoreStatus.db", "P=PLC:plc_ftl_leak_det:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:plc_ftl_leak_det")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:plc_ftl_leak_det")
...
save_restoreSet_status_prefix( "PLC:plc_ftl_leak_det:" )
